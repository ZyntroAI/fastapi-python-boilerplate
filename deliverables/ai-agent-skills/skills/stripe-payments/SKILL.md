...
tags: ["agent", "modular", "progressive-load", "secure", "finance"]
triggers:
    - "stripe"
    - "payment"
    - "ชำระเงิน"
...
สร้าง payment link, ตรวจสถานะชำระเงิน และคืนเงิน

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น stripe, payment, ชำระเงิน
