...
tags: ["agent", "modular", "progressive-load", "secure", "knowledge-work"]
triggers:
    - "notion"
    - "page"
    - "database"
...
อ่าน/เขียนหน้าและฐานข้อมูลใน Notion

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น notion, page, database
