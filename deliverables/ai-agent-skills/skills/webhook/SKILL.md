...
tags: ["agent", "modular", "progressive-load", "secure", "integration"]
triggers:
    - "webhook"
    - "callback"
    - "hook"
...
รับ/ส่ง webhook พร้อมตรวจลายเซ็นและกันการเล่นซ้ำ

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น webhook, callback, hook
