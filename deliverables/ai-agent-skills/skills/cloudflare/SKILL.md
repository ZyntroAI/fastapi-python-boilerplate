...
tags: ["agent", "modular", "progressive-load", "secure", "networking"]
triggers:
    - "cloudflare"
    - "dns"
    - "cache"
...
จัดการ DNS, cache และ rule บน Cloudflare

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น cloudflare, dns, cache
