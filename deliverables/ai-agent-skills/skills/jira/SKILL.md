...
tags: ["agent", "modular", "progressive-load", "secure", "project-management"]
triggers:
    - "jira"
    - "issue"
    - "sprint"
...
สร้าง/อัปเดต issue และดูสถานะ sprint บน Jira

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น jira, issue, sprint
