...
tags: ["agent", "modular", "progressive-load", "secure", "core"]
triggers:
    - "connect"
    - "connection"
    - "เชื่อมต่อ"
...
จัดการการเชื่อมต่อภายนอกแบบ provider-neutral พร้อม health check

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น connect, connection, เชื่อมต่อ
