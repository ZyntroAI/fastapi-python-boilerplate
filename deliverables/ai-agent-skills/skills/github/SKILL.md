...
tags: ["agent", "modular", "progressive-load", "secure", "development"]
triggers:
    - "github"
    - "repo"
    - "pull request"
...
อ่าน/เขียน repo, issue, PR และตรวจสถานะ CI ผ่าน gh CLI

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น github, repo, pull request
