...
tags: ["agent", "modular", "progressive-load", "secure", "cloud"]
triggers:
    - "aws"
    - "s3"
    - "ec2"
...
ตรวจและจัดการทรัพยากร AWS ตามสิทธิ์ที่กำหนด

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น aws, s3, ec2
