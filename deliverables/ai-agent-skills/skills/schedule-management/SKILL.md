...
tags: ["agent", "modular", "progressive-load", "secure", "automation"]
triggers:
    - "schedule"
    - "cron"
    - "ตามกำหนด"
...
สร้าง ตรวจ และยกเลิกงานตามกำหนดเวลา พร้อมบันทึกผลการรัน

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น schedule, cron, ตามกำหนด
