...
tags: ["agent", "modular", "progressive-load", "secure", "security"]
triggers:
    - "oauth"
    - "login"
    - "token"
...
ทำ OAuth 2.0 authorization code flow ฝั่งเบราว์เซอร์ ไม่ส่ง token ผ่านแชท

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น oauth, login, token
