...
tags: ["agent", "modular", "progressive-load", "secure", "productivity"]
triggers:
    - "gmail"
    - "calendar"
    - "drive"
...
อ่านส่งอีเมล จัดการปฏิทิน และไฟล์ใน Drive

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น gmail, calendar, drive
