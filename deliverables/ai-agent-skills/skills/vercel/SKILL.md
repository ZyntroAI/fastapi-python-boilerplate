...
tags: ["agent", "modular", "progressive-load", "secure", "deployment"]
triggers:
    - "vercel"
    - "deploy"
    - "deployment"
...
จัดการ deployment, โดเมน และ environment บน Vercel

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น vercel, deploy, deployment
