...
tags: ["agent", "modular", "progressive-load", "secure", "communication"]
triggers:
    - "email"
    - "resend"
    - "อีเมล"
...
ส่งอีเมลธุรกรรมผ่าน Resend พร้อมตรวจสถานะการส่ง

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น email, resend, อีเมล
