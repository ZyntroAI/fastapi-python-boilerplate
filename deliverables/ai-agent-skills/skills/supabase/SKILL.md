...
tags: ["agent", "modular", "progressive-load", "secure", "data"]
triggers:
    - "supabase"
    - "database"
    - "table"
...
อ่าน/เขียนตารางและตรวจ RLS บน Supabase

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น supabase, database, table
