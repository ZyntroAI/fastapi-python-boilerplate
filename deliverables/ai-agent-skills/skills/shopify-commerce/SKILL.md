...
tags: ["agent", "modular", "progressive-load", "secure", "commerce"]
triggers:
    - "shopify"
    - "product"
    - "order"
...
จัดการสินค้า คำสั่งซื้อ และส่วนลดบนร้าน Shopify

## When to use

ใช้เทคนิคนี้เมื่อคำขอของผู้ใช้เข้าเงื่อนไข trigger ใดเงื่อนไขหนึ่ง เช่น shopify, product, order
