"""Prometheus metrics — ครอบคลุม request/latency/cache/fallback/token"""
from prometheus_client import Counter, Histogram

API_REQUESTS = Counter("onspaceai_api_requests_total", "Total API requests", ["endpoint", "status"])
CACHE_HITS = Counter("onspaceai_cache_hits_total", "Cache hits")
CACHE_MISSES = Counter("onspaceai_cache_misses_total", "Cache misses")
FALLBACK_TOTAL = Counter("onspaceai_fallback_total", "Fallback events", ["from_provider", "to_provider"])
